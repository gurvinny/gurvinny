...
| :--- | :--- |
| 🛡️ **[Security Analyst Portfolio](https://github.com/gurvinny/security-analyst-portfolio)** | Central hub for **SOC Playbooks**, **Sigma Rules**, and **IR Writeups**. |
| 🏠 **[Home Network Lab](https://github.com/gurvinny/home-network-lab)** | Enterprise simulation using **pfSense**, **VLANs**, and **Snort/Suricata**. |
| 🐬 **[Flipper Zero Research](https://github.com/gurvinny/grv-flipper-lab)** | Hardware security, **RF Protocol Analysis**, and access control. |

---

**Certifications:** CompTIA Security+ (In Progress) • TryHackMe SOC Level 1 (Top 4%)
